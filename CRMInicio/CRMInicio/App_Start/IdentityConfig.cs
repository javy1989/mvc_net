...
namespace CRMInicio
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("ricardoj.bravo@hotmail.com", "R1card01989");
            client.EnableSsl = true;
            client.Credentials = credentials;
            try
            {
                var mail = new MailMessage("ricardoj.bravo@hotmail.com", message.Destination.Trim());
